...
c
	 ...
	 if(.not.done) then
            nevent=nevent+1
            if(mod(nevent,100000).eq.0) print *,'At event ',nevent
...
c-- invariant mass
      ...
      enddo
c-- pT of two-particle system
      do i=1, maxclass
         if (ptijplot(i).ne.0) then
            do m=i, maxclass
               if (ptijplot(m).ne.0) then
                  j=1
                  do while (j.le.ptijplot(i).and.j.le.maxevpart(i))
                     n=1
                     do while (n.le.ptijplot(m).and.n.le.maxevpart(m))
                        if (i.ne.m.or.j.lt.n)then ! Removes double counting
                           l=l+1
                           title='pt('//name(i,j)(1:lname(i,j))//','//name(m,n)(1:lname(m,n))//')'
      write (52,*) title
                           call mbook(l,title,ptijrange(1),ptijrange(2),ptijrange(3))
                        endif
                        n=n+1
                     enddo
                     j=j+1
...
c-- delta_y
      do i=1, maxclass
         if (delta_yplot(i).ne.0) then
            do m=i, maxclass
               if (delta_yplot(m).ne.0) then
                  j=1
                  do while (j.le.delta_yplot(i).and.j.le.maxevpart(i))
                     n=1
                     do while (n.le.delta_yplot(m).and.n.le.maxevpart(m))
                        if (i.ne.m.or.j.lt.n)then ! Removes double counting
                           l=l+1
                           title='Deta('//name(i,j)(1:lname(i,j))//','//name(m,n)(1:lname(m,n))//')'
      write (52,*) title
                           call mbook(l,title,delta_yrange(1),delta_yrange(2),delta_yrange(3))
                        endif
                        n=n+1
                     enddo
                     j=j+1
                  ...
                  do while (j.le.ptijplot(i).and.j.le.maxevpart(i))
                     ...
                     do while (n.le.ptijplot(m).and.n.le.maxevpart(m))
                        if (i.ne.m.or.j.lt.n)then ! Removes double counting
                           l=l+1
                           if (eventinfo(i,j).ne.0.and.eventinfo(m,n).ne.0)then
                              call mfill(l,ptij(p(0,eventinfo(i,j)),p(0,eventinfo(m,n))),www)
                           endif
                        endif
                        n=n+1
                     enddo
                  ...
                  do while (j.le.delta_yplot(i).and.j.le.maxevpart(i))
                     ...
                     do while (n.le.delta_yplot(m).and.n.le.maxevpart(m))
                        if (i.ne.m.or.j.lt.n)then ! Removes double counting
                           l=l+1
                           if (eventinfo(i,j).ne.0.and.eventinfo(m,n).ne.0)then
                              call mfill(l,delta_y(p(0,eventinfo(i,j)),p(0,eventinfo(m,n))),www)
                           endif
                        endif
                        n=n+1
                     enddo
...
c-- mom
      do i=1, maxclass 
         if (momplot(i).ne.0 .or. .true. ) then
            j=1
            do while (j.le.momplot(i).and.j.le.maxevpart(i))
               l=l+1
               xtit='|momentum|'
